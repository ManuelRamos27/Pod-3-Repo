...
for day in days:
    print(day) #1.1 this is a loop that prints out each day in the 'days' variable
...
## for day in days:
##    activity = input(f'\nWhat is your favorite thing to do on {day} ')
##1.2 this loop asks the user what their favorite thing to do on that day of the week
...
## for day in days:
##     activity = input(f'\nWhat is your favorite thing to do on {day} ')
##1.3 the empty list 'favorite_activities' will hold each user input for each day of the week 
...
##1.4 the append function will add each of the user's answers into the list 'favorite_activities' so that we can print it out later
...
for x in range(7):
    print(f'On {days[x]}, your favorite activity is {favorite_activities[x]}')
print()
#1.5 in this block of code, we are putting together all the elements so each user input gets saved and printed back out
...
print()
#2 this loop uses an if/elif/else loop to print an answer based on the user's input
...
print()
#3 this loop runs as many times as the user input requests
...
#4 this is a loop that will continue until the desired input is reached

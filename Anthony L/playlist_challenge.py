...
print('<Importing functions from the "playlist_functions.py" file>')
...
print('<Displays the amount of songs in the playlist. It is currently empty>')
...
'''
print('\nQuestion 3')
add_song(my_playlist, {'artist': 'Queen', 'title': 'Bohemian Rhapsody'})

print('<Adding a song into "my_playlist" using the add_song() function>')
...
print('<Checking to see if the song that was added by running the "display_playlist()" function>')

# 5 Add 2 more songs to my_playlist, then display it again using the display_playlist() function
print('\nQuestion 5')
add_song(my_playlist, {'artist': 'Hambone', 'title': 'Boneham'})
add_song(my_playlist, {'artist': 'Freaky Deaky', 'title': 'Dats How Eye Roll'})
display_playlist(my_playlist)

print('<Adding 2 more songs to the playlist and checking to see if they were added>')
...
print('\nQuestion 6')
print(f'My playlist has {get_playlist_length(my_playlist)} songs.')

print('<Displaying the amount of songs in "my_playlist">')


# 7 At the top of this script, import numpy using the usual alias
print('\nQuestion 7')
print('<Importing the function "numpy" from the internal VSC code>')
...
print(f'The average monthly plays for this song is {int(mean(monthly_plays))}.')
print('<Using "numpy" to calculate the average monthly plays for a song>')

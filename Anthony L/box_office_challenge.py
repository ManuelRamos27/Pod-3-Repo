...
remaining_50_list = movies_str.split(',') #converts the string to a list using .split
...
remaining_50_list.remove('The Matrix') #removes the string 'The Matrix' from the variable 'remaining _50_list
...
remaining_50_list.append('Anywhere But Here') #adds the string 'Anywhere But Here' to 'remaining_50_list'
print(remaining_50_list)
...
print(len(remaining_50_list)) #shows the amount of strings in 'remaining_50_list'
...
top_100 = remaining_50_list + top_50_list #this joins the two variables into one list, 'top_100'
print(top_100)
print()
...
print(top_100 [0]) #this prints out only the first value in the list, 'House on Haunted Hill'
print()


# TODO: Let's print the top 10 movies in "top_100" as a list. Let's use the slice syntax to accomplish this!

print(top_100 [0:10]) #this prints out only the first 10 values in the top_100 list
print()
...
top_100_str = str(top_100) #This converts
print(top_100_str)
print()

...
print(ingredient_1, ingredient_2, ingredient_3, ingredient_4) #1.1
...
print(ingredient_1 + " and " + ingredient_2 + " and " + ingredient_3 + " and " + ingredient_4) #1.2
...
ingredients = ingredients.replace(ingredient_1, "butter") #2.5
print(ingredients) #2.5


# 2.6 That looks better. Let's make it official: print the ingredients list all-caps now that it's right.

print(ingredients.upper()) #2.6
...
frequency = "daily" #3.2
print(f"I practice {activity} {frequency}") #3.2

# 3.3 When the user inputs a number, what data type is it saved as?
# Print out the _type_ of the `frequency` variable to check.

print(type(frequency)) #3.3


# 3.4 Uncomment the print statements below, and use `type conversion` to fix the second one, allowing it to run

print('Research shows that making time for enjoyment actually makes you more focused.') #3.4
print(f'We recommend you {activity} at least {frequency * 2} times a week!') #3.4

...
for laptop_name in all_laptops: # This loop will list all the laptops in the all_laptops variable
    print(laptop_name)
print()
...
print(f'1. The url for the Macbook Pro is {laptops[0]["url"]}')

# TODO: Write code to print all possible prices of the 16-inch MacBook Pro.
print(f'2. All possible prices of the 16-inch Macbook Pro are {laptops[0]["types"][1]["price"]}')

# TODO: Write code to print all the color options for Dell XPS 13.
print(f'3. All color options for the Dell XPS 13 are {laptops[1]["types"][0]["colors"]}')

# TODO: Write code to print the description of Dell XPS laptop.
print(f'4. The description of the Dell XPS laptop is as follows: {laptops[1]["description"]}')


print("\nQuestion 2: Out of Stock laptops\n")
...
for i in laptops:
    print(f"\nThe prices for the {i['productName']} are: ")
    for j in i['types']:
        for k in j['price']:
            formatted_price = "${:,.2f}". format(k)

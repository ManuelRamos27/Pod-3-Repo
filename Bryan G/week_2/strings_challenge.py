...
print("1.", ingredient_1, ingredient_2, ingredient_3, ingredient_4)
...
print("2.", ingredient_1 + " " + ingredient_2 + " " +  ingredient_3 + " " + ingredient_4)
...
print(f"3. {ingredient_1} {ingredient_2} {ingredient_3} {ingredient_4}")
...
print("4.", ingredients.replace(ingredient_1, "butter"))
...
print("Milk appears ", ingredients.count("milk"), " time in the string.")

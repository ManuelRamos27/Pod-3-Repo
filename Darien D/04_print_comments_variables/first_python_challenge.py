...
meal = 'Vegan Steak and Mashed Potatoes'
print (meal)
# print('2: How old is Google?')
print ('How old is Google?')
...
current_year = 2022
birth_year = 1993
google_age = int(current_year - birth_year)
...
print ('There was a missing parentheses,single quote, and underscore in the last line.')

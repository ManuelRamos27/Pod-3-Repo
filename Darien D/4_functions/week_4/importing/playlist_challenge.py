...
'''
TooTurnt_Playlist=[]
add_song(TooTurnt_Playlist,{'artist': 'Lil Durk', 'title': 'Make it out'})

# 4 Check that you've added the song by running the display_playlist() function again
print('Question 4')
display_playlist(TooTurnt_Playlist)
# 5 Add 2 more songs to my_playlist, then display it again using the display_playlist() function
print('Question 5')
add_song(TooTurnt_Playlist,{'artist': 'Lil Durk', 'title': 'David Ruffin'})
SoloPlaylist=[]
add_song(SoloPlaylist,{'artist': 'JuiceWrld', 'title': 'Rock Star In His Prime'})
display_playlist(TooTurnt_Playlist)
print()
display_playlist(SoloPlaylist)
...
print('Question 6')
print(get_playlist_length(TooTurnt_Playlist))
...
print('BONUS')
add_song(TooTurnt_Playlist,{'artist':'Doe Boy','title':'I A DO IT'})
play_track(TooTurnt_Playlist,2)
play_track(TooTurnt_Playlist,2)
display_playlist(TooTurnt_Playlist)
play_track(TooTurnt_Playlist,2)
play_track(TooTurnt_Playlist,2)
play_track(TooTurnt_Playlist,1)
play_track(TooTurnt_Playlist)
play_track(TooTurnt_Playlist)
display_playlist(TooTurnt_Playlist)
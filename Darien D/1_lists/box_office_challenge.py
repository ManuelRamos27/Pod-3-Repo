...
remaining_50_list = movies_str.split(',') #Split string into list using .split (',')
print(remaining_50_list)
print("\n")
print(type(remaining_50_list)) #print type of contents in variable
print("\n")
...
remaining_50_list.remove('The Matrix') #Remove The Matrix from "Remaining_50_list"
print(remaining_50_list)

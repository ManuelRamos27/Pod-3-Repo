...
add_song(my_playlist, {'artist': 'Jada Kiss', 'title': 'By Your Side'})
'''
...
print('Question 5')
add_song(my_playlist, {'artist': 'Sheff G', 'title': 'Designer'})
add_song(my_playlist, {'artist': 'Tems', 'title': 'The Key'})
display_playlist(my_playlist)
...
print(f'My playlist contains {len(my_playlist)} songs.')

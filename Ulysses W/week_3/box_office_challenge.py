...
remaining_50_list = movies_str.split(',') #`coverts the string to a list using .split`
...
print(remaining_50_list) #used the remove method 
...
remaining_50_list(len(remaining_50_list)) == 50

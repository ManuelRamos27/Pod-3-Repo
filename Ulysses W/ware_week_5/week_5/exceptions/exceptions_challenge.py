...
def validate_user_input():
    try:
        ...
        print("Please try again ... you did not input a number. Thanks.")
...
def print_tenth_item(top_ten):
    top_ten[10]
    try:
        print(f"The tenth item in the list is {top_ten[-1]}")
    except IndexError:
        print(f"Your index must be less than or equal to 9 ... please try again")
